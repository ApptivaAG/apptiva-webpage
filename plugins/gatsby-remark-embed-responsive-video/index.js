...
var EmbedVideo = /** @class */ (function() {
  ...
  EmbedVideo.prototype.createIframe = function(videoPlatform, url) {
    var iframeNode =
      '<div style="position: relative; margin: 2rem 0; padding-bottom: 56.25%; padding-top: 25px; height: 0;"><iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="' +
      url +
