...
ARG GOOGLE_REVIEWS_API_KEY
ARG GOOGLE_REVIEWS_PLACE_ID
...
ENV GOOGLE_REVIEWS_API_KEY=$GOOGLE_REVIEWS_API_KEY
ENV GOOGLE_REVIEWS_PLACE_ID=$GOOGLE_REVIEWS_PLACE_ID
