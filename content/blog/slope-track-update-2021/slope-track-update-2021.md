...
description: >-
  Für 2021 haben wir einige schöne Verbesserungen und Erweiterungen an der Slope Track App von Suva vornehmen dürfen.
categories:
  - Allgemein
---

Mit dem Update für 2021 der Slope Track App für die Suva bieten wir einige interessante Optimierungen an. So verbessern wir unter anderem die Navigation und Darstellung der aufgezeichneten Abfahrten, erkennen die Abfahrten präzisier und bieten neue Tipps an.

## Bessere Navigation und Darstellung von Abfahrten

Die Abfahrten wurden bisher in einem begrenzten Bereich dargestellt. Zudem waren die Navigations-Elemente und dargestellten Werte zum Track etwas weit auseinander. Neu werden die Navigation und die relevanten Werte näher beieinander platziert. So ist die Navigation einfacher und das auslesen der Werte bequemer.

Zudem kann die Karte nun auch im Vollbild dargestellt werden. In dieser Ansicht nutzen wir den gesamten Bildschirm um den Track darzustellen. Ausserdem ist es in dieser Ansicht möglich, die Karte zu in eine beliebige Richtung zu ziehen, um den gewünschten Bereich anzuzeigen.
...
Die Abfahrten wurden bisher nicht immer korrekt erkannt. Diese Erkennung soll sicher stellen, dass nur die tatsächlichen Abfahrten als solche erkennt werden. Die Pausen und Liftfahrten sollen dabei ignoriert werden. Es konnte aber passieren, dass Teile der Liftfahrt als Abfahrt erkannt oder Teile der Abfahrt nicht erkannt wurden.
...
- **Schneesport-Check**: Um die Risiken zu reduzieren ist es hilfreich die eigenen Risikenpotentiale im Schneesport zu kennen. Entsprechend verweisen wir auf den Schneesport-Check von Suva, wo die Nutzer ihre persönlichen Risiken kennen lernen.
