  ...
  'fixed left-0 z-50 gap-4 bg-white pl-8 !pr-12 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 py-16',
  {
    variants: {
      side: {
        ...
        left: 'rounded-md inset-y-0 left-0 right-0 top-0 bottom-0 bg-primary m-3 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left',
        right:
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn('font-semibold text-lg text-base-white', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={cn('text-sm text-base-white', className)}
    {...props}
  />
))
