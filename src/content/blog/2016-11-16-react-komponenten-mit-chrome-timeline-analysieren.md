...
description: >-
  Heute wurde React 15.4.0 veröffentlicht. Diese ermöglicht
  React Komponenten im den Dev-Tools zu  visualisieren.
  Damit lässt sich erkennen, welche Komponenten mounted, aktualisiert und
  unmounted werden und wie lange dies im Vergleich zu den anderen Komponenten
  dauert.
categories:
  - Softwarearchitektur
  - React
