...
- IP-Adresse
- der Verweis (von welcher anderen Webseite auf unsere verwiesen wird)
...
Mehr zum Datenschutz des Unternehmens Vercel finden Sie unter [Datenschutzerklärung](https://vercel.com/legal/privacy-policy) und [Datenverarbeitung](https://vercel.com/legal/Vercel_Inc_-_Data_Processing_Addendum.pdf).
...
### 3.4 Apptiva Klar (ehemals Bubble Chat)

Für die Chat-Funktion auf unserer Webseite nutzen wir [Apptiva Klar](https://apptiva.ch/angebot/chatbots), eine Eigenentwicklung der Apptiva AG. Unabhängig davon, ob Sie unseren Chat-Bot nutzen oder nicht, werden gewisse Daten, wie IP-Adresse, Datum und Zeit des Webseitenaufrufs, in einem Cookie gespeichert. Wenn Sie unseren Chat-Bot nutzen, wird die ganze Konversation gespeichert.
...
Zusätzlich nutzen wir Snitcher der Snitcher B.V. mit Sitz in den Niederlanden, um die Nutzung unserer Website auszuwerten, wiederkehrende Besucher zu erkennen und die Herkunft von Anfragen besser zuordnen zu können. Snitcher wird mit aktivierter Einwilligungsverwaltung geladen. Eine dauerhafte Wiedererkennung über mehrere Browser-Sitzungen hinweg erfolgt erst, wenn Sie der Kategorie «Analyse & Werbung» in den Cookie-Einstellungen zugestimmt haben. Rechtsgrundlage ist Ihre Einwilligung gemäss Art. 6 Abs. 1 lit. a DSGVO. Weitere Informationen finden Sie in der [Datenschutzerklärung von Snitcher](https://www.snitcher.com/privacy-policy).

### 3.6 OpenAI Conversion-Tracking

Auf unseren Angebotsseiten verwenden wir nach Ihrer Einwilligung in die Kategorie «Analyse & Werbung» ein Conversion-Tracking-Skript von OpenAI. Das Skript wird erst geladen, wenn Sie dieser Kategorie zugestimmt haben. Es ermöglicht uns, die Wirksamkeit unserer Angebotsseiten und Marketingmassnahmen zu messen.

Dabei können insbesondere die IP-Adresse, Informationen zum verwendeten Gerät und Browser, aufgerufene Seiten sowie Datum und Uhrzeit des Besuchs und Conversion-Ereignisse bearbeitet werden. Das Skript kann Cookies oder ähnliche Technologien verwenden und Informationen an OpenAI übermitteln. Wir übermitteln keine Inhalte aus Kontaktformularen oder Chat-Unterhaltungen an dieses Tracking-Skript.

Die Daten können an OpenAI-Unternehmen und deren Dienstleister in der Schweiz, in Irland, den USA oder in weiteren Ländern übermittelt und dort bearbeitet werden. Für Übermittlungen in Länder ohne angemessenes Datenschutzniveau treffen wir geeignete Schutzmassnahmen, insbesondere durch Standardvertragsklauseln oder gestützt auf einen gesetzlich vorgesehenen Ausnahmegrund.

Rechtsgrundlage ist Ihre Einwilligung gemäss Art. 6 Abs. 1 lit. a DSGVO. Sie können Ihre Einwilligung jederzeit mit Wirkung für die Zukunft widerrufen, indem Sie auf der Seite unten auf **Cookie-Einstellungen** klicken und die Kategorie «Analyse & Werbung» deaktivieren. Weitere Informationen finden Sie in der [Datenschutzerklärung von OpenAI](https://openai.com/policies/eu-privacy-policy/) und in der [Cookie-Richtlinie von OpenAI](https://openai.com/policies/cookie-policy/).
...
#### 3.7.1 kSuite (Infomaniak)

Wir nutzen die kSuite-Produkte von Infomaniak, insbesondere kMail für die E-Mail-Kommunikation und kCalendar für die Kalenderverwaltung.

##### kMail

Für die E-Mail-Kommunikation mit Ihnen nutzen wir kMail von Infomaniak. Wenn Sie mit uns per E-Mail in Kontakt treten, werden alle Daten wie Text, Absender, Empfänger sowie Anhänge, die Sie uns oder wir Ihnen zukommen lassen, auf einem Server von Infomaniak gespeichert. Diese Daten werden in der Schweiz gehostet.
...
Zur Verwaltung von Terminen und Kalendern nutzen wir kCalendar von Infomaniak. Die Kalenderdaten werden auf Servern von Infomaniak in der Schweiz gespeichert und verarbeitet.

Für weitere Informationen zum Datenschutz bei Infomaniak siehe: [Datenschutzerklärung](https://www.infomaniak.com/de/rechtliches/datenschutzerklaerung)
...
### 3.10 Google Ads (Google Tag)

Wir verwenden auf unserer Website den Google Ads-Conversion-Tag von Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA ("Google"). Für Nutzer im Europäischen Wirtschaftsraum und der Schweiz ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, verantwortlich.

**Zweck:** Der Tag ermöglicht uns, die Wirksamkeit unserer Google-Werbekampagnen zu messen. Wenn Sie über eine unserer Google-Anzeigen auf unsere Website gelangen und dort eine Conversion-Aktion ausführen (z. B. ein Kontaktformular ausfüllen), wird dies erfasst.

**Verarbeitete Daten:** IP-Adresse (gekürzt), Informationen über das verwendete Gerät und den Browser, aufgerufene Seiten sowie Zeitpunkt des Besuchs. Die Daten werden an Server von Google in den USA übertragen. Google LLC ist unter dem EU–US Data Privacy Framework zertifiziert, was ein angemessenes Datenschutzniveau gewährleistet.

**Cookies:** Google setzt Cookies wie `_gcl_au` (90 Tage) zur Conversion-Messung. Diese Cookies werden ausschliesslich gesetzt, wenn Sie dazu Ihre Einwilligung erteilt haben.

**Rechtsgrundlage:** Ihre Einwilligung gemäss Art. 6 Abs. 1 lit. a DSGVO, die Sie über unser Cookie-Banner erteilen. Die Einwilligung ist freiwillig und kann jederzeit mit Wirkung für die Zukunft widerrufen werden, indem Sie auf der Seite unten auf **Cookie-Einstellungen** klicken und die Kategorie «Analyse & Werbung» deaktivieren.
...
Weitere Informationen zum Datenschutz bei Resend entnehmen Sie bitte der entsprechenden [Datenschutzerklärung](https://resend.com/legal/privacy-policy/).
...
> ## Über die Apptiva AG
>
> Die Apptiva AG ist ein Softwareunternehmen mit Sitz in der Schweiz, das individuelle Softwarelösungen für verschiedene Branchen und Anwendungsbereiche entwickelt. Die Apptiva AG bietet [Mobile Apps](/angebot/development/app-entwicklung), [Web Apps](/angebot/development/webentwicklung) und [Chatbots](/angebot/chatbots) sowie [Produktkonfiguratoren](/angebot/development/konfiguratoren) an, welche die Geschäftsprozesse und die digitale Transformation ihrer Kunden beschleunigen und optimieren. Die Apptiva AG arbeitet eng und direkt mit ihren Kunden zusammen, um passgenaue und qualitativ hochwertige Lösungen zu liefern. Die Projekte der Apptiva AG zeichnen sich durch hohe Usability aus und konnten bisher alle erfolgreich abgeschlossen werden. Die Apptiva AG hat unter anderem die Schweizerische Post, die Screenimage Systems AG und die Suva als Referenzkunden.
